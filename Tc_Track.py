...
# URL of the data
url = "https://www.nrlmry.navy.mil/tcdat/tc2024/WP/WP182024/txt/trackfile.txt"
...
if response.status_code == 200:
    ...
    ax.set_title(title, fontsize=13, fontweight='bold', x=0.475, y=1.01, fontdict={'horizontalalignment': 'center'})
    ...
    plt.suptitle(title_text, fontsize=20, color='red', fontweight='bold', y=0.950)
