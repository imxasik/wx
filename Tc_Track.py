...
if response.status_code == 200:
    ...
    ax.set_title(title_text, fontsize=20, fontweight='bold', color='red', x=0.475, y=1.0125, fontdict={'horizontalalignment': 'center'})
    ...
    ax.set_xlabel(f"Start: {observed_start_time.upper()} | End: {observed_end_time.upper()}", fontsize='16', fontweight='bold')
